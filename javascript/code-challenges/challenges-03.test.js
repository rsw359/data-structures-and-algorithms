...
const typeNum = (arr) => arr.filter(any => typeof any === 'number');
...
const containsAnd = (arr) => arr.filter(any => any.includes('and'));
...
const notInFirstArray = (forbiddenValues, arr) => arr.filter(array2Item => !forbiddenValues.includes(array2Item));
