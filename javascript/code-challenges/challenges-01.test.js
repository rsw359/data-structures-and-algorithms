...
const addOne = (arr) => {
  ...
  return newArray;// Solution code here...
};
...
const addExclamation = (arr) => {
  ...
  return stringArray;// Solution code here...
};
...
const allUpperCase = (arr) => {
  let upperArray = [];
  arr.forEach(str => {
    upperArray.push(str.toUpperCase());
  });
  return upperArray;// Solution code here...
};
...
const greeting = (word) => {
  ...
  return greet; // Solution code here...
};

const speaker = (words, callback) => {
  let speakArray = [];
  words.forEach(str => {
    speakArray.push(callback(str));
  });

  return speakArray;// Solution code here...
};
...
const createList = (availableItems) => {
  let inventory = [];
  availableItems.forEach(avail => {
    if (avail.available === true) {
      inventory.push(avail.name);
    }
